 ...
 * accessibility until the real photo is added.
 *
 * Replace the .hp-about-img-placeholder div with an <img> or get_the_post_thumbnail()
 * call once the founder photo is available.
 *
 * @package Datalkemi
 * @since   2.0.0
 */
...
<section class="hp-about" aria-labelledby="about-heading">
	<div class="hp-container">
		<div class="hp-about-layout">
			...
			<figure class="hp-about-figure">
				<div
					class="hp-about-img-placeholder"
					role="img"
					aria-label="<?php esc_attr_e( 'Placeholder for founder photo of Naufal, Datalkemi', 'datalkemi' ); ?>"
				>
